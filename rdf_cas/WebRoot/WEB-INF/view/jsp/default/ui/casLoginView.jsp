...
<!-- 			<form autocomplete="off" id="fm1" action="rdf_cas/login" commandName="${commandName}" htmlEscape="true" method="POST">  -->
				<form:form method="post" id="fm1" cssClass="fm-v clearfix" commandName="${commandName}" htmlEscape="true">
					...
					<!-- 	<input id="username" type="text" name="username" class="pass-text-input pass-text-input-account" autocomplete="off" value="${sessionScope.openIdLocalId}" placeholder="邮箱"> -->
					...
					<!-- 	<input id="password" type="password" name="password" class="pass-text-input pass-text-input-password" autocomplete="off" placeholder="密码"> -->
						...
						<form:password id="password" name="password" class="pass-text-input pass-text-input-password" tabindex="2" path="password"  accesskey="${passwordAccessKey}" htmlEscape="true" autocomplete="off" placeholder="密码" />
